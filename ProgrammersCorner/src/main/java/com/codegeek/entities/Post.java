...
public class Post {
	...
	public Post() {
		...
		public Post(String pTitle, String pContent, String pCode, int catId) {
			super();
			this.pTitle = pTitle;
			this.pContent = pContent;
			this.pCode = pCode;
	  ...
	  public Timestamp getpDate() { return pDate; }
	 
	
	  public void setpDate(Timestamp pDate) { this.pDate = pDate; }
